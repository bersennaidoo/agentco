...
type ServerInterface interface {
	...
	// (GET /jobs)
	ListOrSearchAvailableJobs(c *gin.Context, params ListOrSearchAvailableJobsParams)
	// Create Job
	// (POST /jobs)
...
func (siw *ServerInterfaceWrapper) ModifyJobApplicationWithId(c *gin.Context) {
	...
	c.Set(SessionTokenScopes, []string{})
...
func (siw *ServerInterfaceWrapper) ListOrSearchAvailableJobs(c *gin.Context) {
	...
	var params ListOrSearchAvailableJobsParams
